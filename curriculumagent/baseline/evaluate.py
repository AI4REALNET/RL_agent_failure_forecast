...
def evaluate(
    ...
    Args:
        ...
        environments please retrain the network36 in advance.
        load_path: The path where the model is stored. This is used by the network36 when calling "network36.load()"
        ...
        episode. Note, that depending on the environment (and the performance of your network36) this creation of the gif
    ...
    # Create the network36 (this piece of code can change)
