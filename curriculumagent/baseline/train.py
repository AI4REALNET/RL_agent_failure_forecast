...
def train(
    ...
    For a quick training the CurriculumAgent we recommend to use the network36.train() method to only
    train the RL network36. This, however, requires that you already have an model and an action set.

    If you want/have to start at zero and need to find actions as well as the model, feel free to run
    this pipeline. This pipeline will create for each step (network36) in the pipeline a directory.
    ...
    Args:
        ...
        name: Name of the Training network36.
