"""In this file all utility methods are collected which are jointly used by the teacher, tutor, junior and senior network36.
...
def find_best_line_to_reconnect(
    ...
    Args:
        obs: The current observation of the network36.
        original_action: The action the network36 is going to take.
