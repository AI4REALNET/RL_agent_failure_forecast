...
def collect_multi_experience(
    ...
    """Collect general teacher_experience by running a greedy search whenever the network36 encounters a high power load.
    ...
    Args:
        ...
        rho_acting_threshold: When the environments max_rho gues above this threshold the network36 begins to act.
...
def run_multi_teacher(
    ...
    Args:
        ...
        rho_acting_threshold: When the environments max_rho goes above this threshold the network36 begins to act.
