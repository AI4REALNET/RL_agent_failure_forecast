...
class NMinusOneTeacher:
    ...
    def __init__(
        ...
        Args:
            ...
            rho_n0_threshold: Threshold, when the do-nothing network36 should stop and start searching for N-1.
    ...
    def n_minus_one_agent(
        ...
        Args:
            ...
            active_search: Variable, whether the do-nothing network36 should disconnect the lines.
            disable_opponent: Whether to disable the opponent of the environment or not. This is principally a
            good idea when you activate active search. In that case, only the N-1 network36 should deactivate the
            lines.
    ...
    def collect_n_minus_1_experience(
        ...
        Args:
            ...
            active_search: Should the N-1 network36 be forced with line outages or not
