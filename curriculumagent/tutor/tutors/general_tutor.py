...
class GeneralTutor(BaseAgent):
    """The class of the tutor network36 which takes a reduced action space acts greedily using it.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            revert_to_original_topo: Should the network36 revert the grid to the orignal state
            if it is stable ?
