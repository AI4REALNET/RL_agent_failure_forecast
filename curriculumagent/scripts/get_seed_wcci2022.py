...
def run_evaluation_of_env(agent_dict: dict, env: BaseEnv, out_path: Path, seed: Optional[int]) -> Tuple[dict, dict]:
    ...
    Note: The do nothing network36 is always provided!
    ...
    print(f"The Do-Nothing network36 has the scores of: {dn_report.score_data['all_scores']}")
...
def create_agents_and_env():
    ...
    Returns: dictionary of network36
